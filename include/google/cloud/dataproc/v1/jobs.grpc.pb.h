 ...
 public:
  ...
  class WithAsyncMethod_UpdateJob : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status UpdateJob(::grpc::ServerContext* context, const ::google::cloud::dataproc::v1::UpdateJobRequest* request, ::google::cloud::dataproc::v1::Job* response) final override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
