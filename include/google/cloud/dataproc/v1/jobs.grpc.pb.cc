...
::grpc::Status JobController::Stub::UpdateJob(::grpc::ClientContext* context, const ::google::cloud::dataproc::v1::UpdateJobRequest& request, ::google::cloud::dataproc::v1::Job* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_UpdateJob_, context, request, response);
}

::grpc::ClientAsyncResponseReader< ::google::cloud::dataproc::v1::Job>* JobController::Stub::AsyncUpdateJobRaw(::grpc::ClientContext* context, const ::google::cloud::dataproc::v1::UpdateJobRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::google::cloud::dataproc::v1::Job>::Create(channel_.get(), cq, rpcmethod_UpdateJob_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::google::cloud::dataproc::v1::Job>* JobController::Stub::PrepareAsyncUpdateJobRaw(::grpc::ClientContext* context, const ::google::cloud::dataproc::v1::UpdateJobRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::google::cloud::dataproc::v1::Job>::Create(channel_.get(), cq, rpcmethod_UpdateJob_, context, request, false);
}
...
JobController::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< JobController::Service, ::google::cloud::dataproc::v1::UpdateJobRequest, ::google::cloud::dataproc::v1::Job>(
...
::grpc::Status JobController::Service::UpdateJob(::grpc::ServerContext* context, const ::google::cloud::dataproc::v1::UpdateJobRequest* request, ::google::cloud::dataproc::v1::Job* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
