...
::grpc::Status LanguageService::Stub::ClassifyText(::grpc::ClientContext* context, const ::google::cloud::language::v1::ClassifyTextRequest& request, ::google::cloud::language::v1::ClassifyTextResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_ClassifyText_, context, request, response);
}

::grpc::ClientAsyncResponseReader< ::google::cloud::language::v1::ClassifyTextResponse>* LanguageService::Stub::AsyncClassifyTextRaw(::grpc::ClientContext* context, const ::google::cloud::language::v1::ClassifyTextRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::google::cloud::language::v1::ClassifyTextResponse>::Create(channel_.get(), cq, rpcmethod_ClassifyText_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::google::cloud::language::v1::ClassifyTextResponse>* LanguageService::Stub::PrepareAsyncClassifyTextRaw(::grpc::ClientContext* context, const ::google::cloud::language::v1::ClassifyTextRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::google::cloud::language::v1::ClassifyTextResponse>::Create(channel_.get(), cq, rpcmethod_ClassifyText_, context, request, false);
}
...
LanguageService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< LanguageService::Service, ::google::cloud::language::v1::ClassifyTextRequest, ::google::cloud::language::v1::ClassifyTextResponse>(
...
::grpc::Status LanguageService::Service::ClassifyText(::grpc::ServerContext* context, const ::google::cloud::language::v1::ClassifyTextRequest* request, ::google::cloud::language::v1::ClassifyTextResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
