 ...
 public:
  ...
  class WithAsyncMethod_ClassifyText : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status ClassifyText(::grpc::ServerContext* context, const ::google::cloud::language::v1::ClassifyTextRequest* request, ::google::cloud::language::v1::ClassifyTextResponse* response) final override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
