 ...
 public:
  ...
  class WithAsyncMethod_ListVoices : public BaseClass {
   ...
   public:
    ...
    ::grpc::Status ListVoices(::grpc::ServerContext* context, const ::google::cloud::texttospeech::v1::ListVoicesRequest* request, ::google::cloud::texttospeech::v1::ListVoicesResponse* response) final override {
      abort();
  ...
  class WithAsyncMethod_SynthesizeSpeech : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status SynthesizeSpeech(::grpc::ServerContext* context, const ::google::cloud::texttospeech::v1::SynthesizeSpeechRequest* request, ::google::cloud::texttospeech::v1::SynthesizeSpeechResponse* response) final override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
