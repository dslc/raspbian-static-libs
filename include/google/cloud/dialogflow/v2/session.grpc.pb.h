 ...
 public:
  ...
  class WithAsyncMethod_DetectIntent : public BaseClass {
   ...
   public:
    ...
    ::grpc::Status DetectIntent(::grpc::ServerContext* context, const ::google::cloud::dialogflow::v2::DetectIntentRequest* request, ::google::cloud::dialogflow::v2::DetectIntentResponse* response) final override {
      abort();
  ...
  class WithAsyncMethod_StreamingDetectIntent : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status StreamingDetectIntent(::grpc::ServerContext* context, ::grpc::ServerReaderWriter< ::google::cloud::dialogflow::v2::StreamingDetectIntentResponse, ::google::cloud::dialogflow::v2::StreamingDetectIntentRequest>* stream) final override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
